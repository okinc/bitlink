 ...
 */
#ifndef BITLINK_ADDRESS_HPP
#define BITLINK_ADDRESS_HPP
...
{
    template <>
    struct hash<payment_address>
    {
        size_t operator()(const payment_address& payaddr) const
        {
            std::string raw_addr;
