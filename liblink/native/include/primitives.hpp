...
#ifndef BITLINK_PRIMITIVES_HPP
#define BITLINK_PRIMITIVES_HPP
...
typedef boost::array<uint8_t, 16> ip_address_type;
...
namespace inventory_type_id
{
enum inventory_type_id
{
    error,
    transaction,
    block,
...
{
    inventory_type_id::inventory_type_id type;
    hash_digest hash;
};
